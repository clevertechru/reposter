  ...
  def create
    ...
    respond_to do |format|
      if @platform_category.save
        format.html { redirect_to @platform_category, notice: 'Platform category was successfully created.' }
  ...
  def update
    ...
    respond_to do |format|
      if @platform_category.update_attributes(params[:platform_category])
        format.html { redirect_to @platform_category, notice: 'Platform category was successfully updated.' }
