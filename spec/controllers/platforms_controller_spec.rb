  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved platform as @platform" do
        ...
        post :create, {:platform => { "user_id" => "invalid value" }}, valid_session
        assigns(:platform).should be_a_new(Platform)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested platform" do
        ...
        Platform.any_instance.should_receive(:update_attributes).with({ "user_id" => "1" })
        put :update, {:id => platform.to_param, :platform => { "user_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the platform as @platform" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Platform.any_instance.stub(:save).and_return(false)
        put :update, {:id => platform.to_param, :platform => { "user_id" => "invalid value" }}, valid_session
        assigns(:platform).should eq(platform)
      end
